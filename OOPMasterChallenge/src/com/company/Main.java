...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // hint: you probably want to process the additional items in this new class (subclass of Hamburger),
        // not the base class (Hamburger), since the two additions are only appropriate for this new class
        // (in other words new burger type).
        // b) Deluxe hamburger - comes with chips and drinks as additions are only appropriate for this new class
        ...
        db.itemizeHamburger();
        db.addHamburgerAddition1("Should not do this", 50.13);
